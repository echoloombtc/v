...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/kenDevXD/v/main/ssh/proxy3.js"
...
wget -q -O /usr/bin/sshws-service "https://raw.githubusercontent.com/kenDevXD/v/main/ssh/sshws-true.sh" && chmod +x /usr/bin/sshws-service && /usr/bin/sshws-service
