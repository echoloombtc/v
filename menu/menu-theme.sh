...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Tarap-kenDevXD/ip/main/vps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Tarap-kenDevXD/ip/main/vps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Tarap-kenDevXD/ip/main/vps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
01 | 1)
clear
echo "blue" >/etc/kenDevXD/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
02 | 2)
clear
echo "red" >/etc/kenDevXD/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
03 | 3)
clear
echo "yellow" >/etc/kenDevXD/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
04 | 4)
clear
echo "cyan" >/etc/kenDevXD/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
05 | 5)
clear
echo "green" >/etc/kenDevXD/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
06 | 6)
clear
echo "magenta" >/etc/kenDevXD/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
